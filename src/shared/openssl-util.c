...
#if OPENSSL_VERSION_MAJOR >= 3
        md = EVP_MD_fetch(NULL, digest_alg, NULL);
#else
        md = (EVP_MD*) EVP_get_digestbyname(digest_alg);
#endif
        if (!md)
...
/* Provides the number of bytes generated by the specified digest algorithm. This can be used only for
