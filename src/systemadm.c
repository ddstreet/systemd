/* systemadm.c generated by valac 0.11.4, the Vala compiler
	...
	}
	{
		...
		for (i_it = 0; i_it < list_length1; i_it = i_it + 1) {
			...
			i = _tmp3_;
			{
				...
				gchar* _tmp10_;
				if (user) {
					_tmp5_ = G_BUS_TYPE_SESSION;
				} else {
					_tmp5_ = G_BUS_TYPE_SYSTEM;
				}
				_tmp6_ = g_initable_new (TYPE_PROPERTIES_PROXY, NULL, &_inner_error_, "g-flags", 0, "g-name", "org.freedesktop.systemd1", "g-bus-type", _tmp5_, "g-object-path", (const gchar*) i.unit_path, "g-interface-name", "org.freedesktop.Properties", NULL);
				p = (Properties*) _tmp6_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == G_IO_ERROR) {
						g_propagate_error (error, _inner_error_);
				...
				_tmp8_ = g_initable_new (TYPE_UNIT_PROXY, NULL, &_inner_error_, "g-flags", 0, "g-name", "org.freedesktop.systemd1", "g-bus-type", _tmp7_, "g-object-path", (const gchar*) i.unit_path, "g-interface-name", "org.freedesktop.systemd1.Unit", NULL);
				u = (Unit*) _tmp8_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == G_IO_ERROR) {
						g_propagate_error (error, _inner_error_);
				...
				gtk_list_store_append (self->priv->unit_model, &_tmp9_);
				iter = _tmp9_;
				_tmp10_ = NULL;
				if (g_strcmp0 (i.job_type, "") != 0) {
					gchar* _tmp11_ = NULL;
					gchar* _tmp12_;
					_tmp11_ = g_strdup_printf ("→ %s", i.job_type);
					_tmp12_ = _tmp11_;
					_g_free0 (_tmp10_);
					_tmp10_ = _tmp12_;
				} else {
				...
				gtk_list_store_set (self->priv->unit_model, &iter, 0, i.id, 1, i.description, 2, i.load_state, 3, i.active_state, 4, i.sub_state, 5, _tmp10_, 6, u, -1);
				_g_free0 (_tmp10_);
				_g_object_unref0 (u);
				_g_object_unref0 (p);
				manager_unit_info_destroy (&i);
	...
	}
	{
		...
		for (i_it = 0; i_it < list_length1; i_it = i_it + 1) {
			...
			i = _tmp3_;
			{
				...
				_tmp6_ = g_initable_new (TYPE_PROPERTIES_PROXY, NULL, &_inner_error_, "g-flags", 0, "g-name", "org.freedesktop.systemd1", "g-bus-type", _tmp5_, "g-object-path", (const gchar*) i.job_path, "g-interface-name", "org.freedesktop.Properties", NULL);
				p = (Properties*) _tmp6_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == G_IO_ERROR) {
						g_propagate_error (error, _inner_error_);
				...
				_tmp8_ = g_initable_new (TYPE_JOB_PROXY, NULL, &_inner_error_, "g-flags", 0, "g-name", "org.freedesktop.systemd1", "g-bus-type", _tmp7_, "g-object-path", (const gchar*) i.job_path, "g-interface-name", "org.freedesktop.systemd1.Job", NULL);
				j = (Job*) _tmp8_;
				if (_inner_error_ != NULL) {
					if (_inner_error_->domain == G_IO_ERROR) {
						g_propagate_error (error, _inner_error_);
				...
				gtk_list_store_append (self->priv->job_model, &_tmp9_);
				iter = _tmp9_;
				_tmp10_ = g_strdup_printf ("%u", (guint) i.id);
				_tmp11_ = _tmp10_;
				_tmp12_ = g_strdup_printf ("→ %s", i.type);
				_tmp13_ = _tmp12_;
				gtk_list_store_set (self->priv->job_model, &iter, 0, _tmp11_, 1, i.name, 2, _tmp13_, 3, i.state, 4, j, 5, i.id, -1);
				_g_free0 (_tmp13_);
				_g_free0 (_tmp11_);
				_g_object_unref0 (j);
				_g_object_unref0 (p);
