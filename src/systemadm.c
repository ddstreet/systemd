/* systemadm.c generated by valac 0.12.0, the Vala compiler
...
MainWindow* main_window_construct (GType object_type, GError** error) {
	...
	RightLabel* _tmp40_ = NULL;
	RightLabel* _tmp41_ = NULL;
	RightLabel* _tmp42_ = NULL;
	RightLabel* _tmp43_ = NULL;
	RightLabel* _tmp44_ = NULL;
	RightLabel* _tmp45_ = NULL;
	RightLabel* _tmp46_ = NULL;
	RightLabel* _tmp47_ = NULL;
	RightLabel* _tmp48_ = NULL;
	RightLabel* _tmp49_ = NULL;
	RightLabel* _tmp50_ = NULL;
	RightLabel* _tmp51_ = NULL;
	RightLabel* _tmp52_ = NULL;
	RightLabel* _tmp53_ = NULL;
	RightLabel* _tmp54_ = NULL;
	RightLabel* _tmp55_ = NULL;
	GtkTable* _tmp56_ = NULL;
	GtkTable* unit_table;
	GtkTable* _tmp57_ = NULL;
	GtkTable* job_table;
	LeftLabel* _tmp58_ = NULL;
	LeftLabel* _tmp59_;
	LeftLabel* _tmp60_ = NULL;
	LeftLabel* _tmp61_;
	LeftLabel* _tmp62_ = NULL;
	LeftLabel* _tmp63_;
	LeftLabel* _tmp64_ = NULL;
	LeftLabel* _tmp65_;
	LeftLabel* _tmp66_ = NULL;
	LeftLabel* _tmp67_;
	LeftLabel* _tmp68_ = NULL;
	LeftLabel* _tmp69_;
	LeftLabel* _tmp70_ = NULL;
	LeftLabel* _tmp71_;
	LeftLabel* _tmp72_ = NULL;
	LeftLabel* _tmp73_;
	LeftLabel* _tmp74_ = NULL;
	LeftLabel* _tmp75_;
	LeftLabel* _tmp76_ = NULL;
	LeftLabel* _tmp77_;
	LeftLabel* _tmp78_ = NULL;
	LeftLabel* _tmp79_;
	LeftLabel* _tmp80_ = NULL;
	LeftLabel* _tmp81_;
	LeftLabel* _tmp82_ = NULL;
	LeftLabel* _tmp83_;
	LeftLabel* _tmp84_ = NULL;
	LeftLabel* _tmp85_;
	LeftLabel* _tmp86_ = NULL;
	LeftLabel* _tmp87_;
	LeftLabel* _tmp88_ = NULL;
	LeftLabel* _tmp89_;
	...
	GtkHButtonBox* _tmp95_ = NULL;
	GtkButton* _tmp96_ = NULL;
	GBusType _tmp97_ = 0;
	Manager* _tmp98_ = NULL;
	Manager* _tmp99_;
	...
	self->priv->unit_type_combo_box = g_object_ref_sink (_tmp8_);
	_tmp9_ = (GtkHBox*) gtk_hbox_new (FALSE, 6);
	type_hbox = (GtkBox*) g_object_ref_sink (_tmp9_);
	...
	self->priv->unit_load_entry = g_object_ref_sink (_tmp10_);
	_tmp11_ = (GtkButton*) gtk_button_new_with_mnemonic ("_Load");
	_g_object_unref0 (self->priv->unit_load_button);
	self->priv->unit_load_button = g_object_ref_sink (_tmp11_);
	...
	_tmp12_ = (GtkHBox*) gtk_hbox_new (FALSE, 6);
	unit_load_hbox = (GtkBox*) g_object_ref_sink (_tmp12_);
	...
	_tmp13_ = (GtkButton*) gtk_button_new_with_mnemonic ("Take S_napshot");
	_g_object_unref0 (self->priv->server_snapshot_button);
	self->priv->server_snapshot_button = g_object_ref_sink (_tmp13_);
	_tmp14_ = (GtkButton*) gtk_button_new_with_mnemonic ("Reload _Configuration");
	_g_object_unref0 (self->priv->server_reload_button);
	self->priv->server_reload_button = g_object_ref_sink (_tmp14_);
	...
	_tmp15_ = gtk_list_store_new (7, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, TYPE_UNIT);
	_g_object_unref0 (self->priv->unit_model);
	self->priv->unit_model = _tmp15_;
	_tmp16_ = gtk_list_store_new (6, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, TYPE_JOB, G_TYPE_UINT);
	_g_object_unref0 (self->priv->job_model);
	self->priv->job_model = _tmp16_;
	_tmp17_ = (GtkTreeModelFilter*) gtk_tree_model_filter_new ((GtkTreeModel*) self->priv->unit_model, NULL);
	_g_object_unref0 (unit_model_filter);
	unit_model_filter = _tmp17_;
	...
	_tmp18_ = (GtkTreeView*) gtk_tree_view_new_with_model ((GtkTreeModel*) unit_model_filter);
	_g_object_unref0 (self->priv->unit_view);
	self->priv->unit_view = g_object_ref_sink (_tmp18_);
	_tmp19_ = (GtkTreeView*) gtk_tree_view_new_with_model ((GtkTreeModel*) self->priv->job_model);
	_g_object_unref0 (self->priv->job_view);
	self->priv->job_view = g_object_ref_sink (_tmp19_);
	...
	gtk_tree_view_insert_column_with_attributes (self->priv->unit_view, -1, "Load State", (GtkCellRenderer*) _tmp21_, "text", 2, NULL);
	_g_object_unref0 (_tmp21_);
	_tmp22_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp23_ = g_object_ref_sink (_tmp22_);
	gtk_tree_view_insert_column_with_attributes (self->priv->unit_view, -1, "Active State", (GtkCellRenderer*) _tmp23_, "text", 3, NULL);
	_g_object_unref0 (_tmp23_);
	_tmp24_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp25_ = g_object_ref_sink (_tmp24_);
	gtk_tree_view_insert_column_with_attributes (self->priv->unit_view, -1, "Unit State", (GtkCellRenderer*) _tmp25_, "text", 4, NULL);
	_g_object_unref0 (_tmp25_);
	_tmp26_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp27_ = g_object_ref_sink (_tmp26_);
	gtk_tree_view_insert_column_with_attributes (self->priv->unit_view, -1, "Unit", (GtkCellRenderer*) _tmp27_, "text", 0, NULL);
	_g_object_unref0 (_tmp27_);
	_tmp28_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp29_ = g_object_ref_sink (_tmp28_);
	gtk_tree_view_insert_column_with_attributes (self->priv->unit_view, -1, "Job", (GtkCellRenderer*) _tmp29_, "text", 5, NULL);
	_g_object_unref0 (_tmp29_);
	_tmp30_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp31_ = g_object_ref_sink (_tmp30_);
	gtk_tree_view_insert_column_with_attributes (self->priv->job_view, -1, "Job", (GtkCellRenderer*) _tmp31_, "text", 0, NULL);
	_g_object_unref0 (_tmp31_);
	_tmp32_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp33_ = g_object_ref_sink (_tmp32_);
	gtk_tree_view_insert_column_with_attributes (self->priv->job_view, -1, "Unit", (GtkCellRenderer*) _tmp33_, "text", 1, NULL);
	_g_object_unref0 (_tmp33_);
	_tmp34_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp35_ = g_object_ref_sink (_tmp34_);
	gtk_tree_view_insert_column_with_attributes (self->priv->job_view, -1, "Type", (GtkCellRenderer*) _tmp35_, "text", 2, NULL);
	_g_object_unref0 (_tmp35_);
	_tmp36_ = (GtkCellRendererText*) gtk_cell_renderer_text_new ();
	_tmp37_ = g_object_ref_sink (_tmp36_);
	gtk_tree_view_insert_column_with_attributes (self->priv->job_view, -1, "State", (GtkCellRenderer*) _tmp37_, "text", 3, NULL);
	_g_object_unref0 (_tmp37_);
	_tmp38_ = (GtkScrolledWindow*) gtk_scrolled_window_new (NULL, NULL);
	scroll = g_object_ref_sink (_tmp38_);
	...
	scroll = g_object_ref_sink (_tmp39_);
	gtk_scrolled_window_set_policy (scroll, GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
	gtk_scrolled_window_set_shadow_type (scroll, GTK_SHADOW_IN);
	...
	_tmp40_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_id_label);
	self->priv->unit_id_label = g_object_ref_sink (_tmp40_);
	_tmp41_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_aliases_label);
	self->priv->unit_aliases_label = g_object_ref_sink (_tmp41_);
	_tmp42_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_dependency_label);
	self->priv->unit_dependency_label = g_object_ref_sink (_tmp42_);
	_tmp43_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_description_label);
	self->priv->unit_description_label = g_object_ref_sink (_tmp43_);
	_tmp44_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_load_state_label);
	self->priv->unit_load_state_label = g_object_ref_sink (_tmp44_);
	_tmp45_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_active_state_label);
	self->priv->unit_active_state_label = g_object_ref_sink (_tmp45_);
	_tmp46_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_sub_state_label);
	self->priv->unit_sub_state_label = g_object_ref_sink (_tmp46_);
	_tmp47_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_fragment_path_label);
	self->priv->unit_fragment_path_label = g_object_ref_sink (_tmp47_);
	_tmp48_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_active_enter_timestamp_label);
	self->priv->unit_active_enter_timestamp_label = g_object_ref_sink (_tmp48_);
	_tmp49_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_active_exit_timestamp_label);
	self->priv->unit_active_exit_timestamp_label = g_object_ref_sink (_tmp49_);
	_tmp50_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_can_start_label);
	self->priv->unit_can_start_label = g_object_ref_sink (_tmp50_);
	_tmp51_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_can_reload_label);
	self->priv->unit_can_reload_label = g_object_ref_sink (_tmp51_);
	_tmp52_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->unit_cgroup_label);
	self->priv->unit_cgroup_label = g_object_ref_sink (_tmp52_);
	_tmp53_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->job_id_label);
	self->priv->job_id_label = g_object_ref_sink (_tmp53_);
	_tmp54_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->job_state_label);
	self->priv->job_state_label = g_object_ref_sink (_tmp54_);
	_tmp55_ = right_label_new (NULL);
	_g_object_unref0 (self->priv->job_type_label);
	self->priv->job_type_label = g_object_ref_sink (_tmp55_);
	...
	_tmp56_ = (GtkTable*) gtk_table_new ((guint) 8, (guint) 6, FALSE);
	unit_table = g_object_ref_sink (_tmp56_);
	...
	_tmp57_ = (GtkTable*) gtk_table_new ((guint) 2, (guint) 2, FALSE);
	job_table = g_object_ref_sink (_tmp57_);
	...
	_tmp58_ = left_label_new ("Id:");
	_tmp59_ = g_object_ref_sink (_tmp58_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp59_, (guint) 0, (guint) 1, (guint) 0, (guint) 1, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp60_ = left_label_new ("Aliases:");
	_tmp61_ = g_object_ref_sink (_tmp60_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp61_, (guint) 0, (guint) 1, (guint) 1, (guint) 2, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp62_ = left_label_new ("Description:");
	_tmp63_ = g_object_ref_sink (_tmp62_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp63_, (guint) 0, (guint) 1, (guint) 2, (guint) 3, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp64_ = left_label_new ("Dependencies:");
	_tmp65_ = g_object_ref_sink (_tmp64_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp65_, (guint) 0, (guint) 1, (guint) 3, (guint) 4, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp66_ = left_label_new ("Fragment Path:");
	_tmp67_ = g_object_ref_sink (_tmp66_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp67_, (guint) 0, (guint) 1, (guint) 4, (guint) 5, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp68_ = left_label_new ("Control Group:");
	_tmp69_ = g_object_ref_sink (_tmp68_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp69_, (guint) 0, (guint) 1, (guint) 5, (guint) 6, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp70_ = left_label_new ("Load State:");
	_tmp71_ = g_object_ref_sink (_tmp70_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp71_, (guint) 0, (guint) 1, (guint) 6, (guint) 7, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp72_ = left_label_new ("Active State:");
	_tmp73_ = g_object_ref_sink (_tmp72_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp73_, (guint) 0, (guint) 1, (guint) 7, (guint) 8, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp74_ = left_label_new ("Unit State:");
	_tmp75_ = g_object_ref_sink (_tmp74_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp75_, (guint) 0, (guint) 1, (guint) 8, (guint) 9, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp76_ = left_label_new ("Active Enter Timestamp:");
	_tmp77_ = g_object_ref_sink (_tmp76_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp77_, (guint) 2, (guint) 3, (guint) 7, (guint) 8, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp78_ = left_label_new ("Active Exit Timestamp:");
	_tmp79_ = g_object_ref_sink (_tmp78_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp79_, (guint) 2, (guint) 3, (guint) 8, (guint) 9, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp80_ = left_label_new ("Can Start/Stop:");
	_tmp81_ = g_object_ref_sink (_tmp80_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp81_, (guint) 4, (guint) 5, (guint) 7, (guint) 8, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp82_ = left_label_new ("Can Reload:");
	_tmp83_ = g_object_ref_sink (_tmp82_);
	gtk_table_attach (unit_table, (GtkWidget*) _tmp83_, (guint) 4, (guint) 5, (guint) 8, (guint) 9, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp84_ = left_label_new ("Id:");
	_tmp85_ = g_object_ref_sink (_tmp84_);
	gtk_table_attach (job_table, (GtkWidget*) _tmp85_, (guint) 0, (guint) 1, (guint) 0, (guint) 1, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp86_ = left_label_new ("State:");
	_tmp87_ = g_object_ref_sink (_tmp86_);
	gtk_table_attach (job_table, (GtkWidget*) _tmp87_, (guint) 0, (guint) 1, (guint) 1, (guint) 2, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	_tmp88_ = left_label_new ("Type:");
	_tmp89_ = g_object_ref_sink (_tmp88_);
	gtk_table_attach (job_table, (GtkWidget*) _tmp89_, (guint) 0, (guint) 1, (guint) 2, (guint) 3, GTK_FILL, GTK_FILL, (guint) 0, (guint) 0);
	...
	bbox = (GtkButtonBox*) g_object_ref_sink (_tmp90_);
	...
	_tmp91_ = (GtkButton*) gtk_button_new_with_mnemonic ("_Start");
	_g_object_unref0 (self->priv->start_button);
	self->priv->start_button = g_object_ref_sink (_tmp91_);
	_tmp92_ = (GtkButton*) gtk_button_new_with_mnemonic ("Sto_p");
	_g_object_unref0 (self->priv->stop_button);
	self->priv->stop_button = g_object_ref_sink (_tmp92_);
	_tmp93_ = (GtkButton*) gtk_button_new_with_mnemonic ("_Reload");
	_g_object_unref0 (self->priv->reload_button);
	self->priv->reload_button = g_object_ref_sink (_tmp93_);
	_tmp94_ = (GtkButton*) gtk_button_new_with_mnemonic ("Res_tart");
	_g_object_unref0 (self->priv->restart_button);
	self->priv->restart_button = g_object_ref_sink (_tmp94_);
	...
	_tmp95_ = (GtkHButtonBox*) gtk_hbutton_box_new ();
	_g_object_unref0 (bbox);
	bbox = (GtkButtonBox*) g_object_ref_sink (_tmp95_);
	gtk_button_box_set_layout (bbox, GTK_BUTTONBOX_START);
	gtk_box_set_spacing ((GtkBox*) bbox, 6);
	gtk_box_pack_start (job_vbox, (GtkWidget*) bbox, FALSE, TRUE, (guint) 0);
	_tmp96_ = (GtkButton*) gtk_button_new_with_mnemonic ("_Cancel");
	_g_object_unref0 (self->priv->cancel_button);
	self->priv->cancel_button = g_object_ref_sink (_tmp96_);
	...
	if (user) {
		_tmp97_ = G_BUS_TYPE_SESSION;
	} else {
		_tmp97_ = G_BUS_TYPE_SYSTEM;
	}
	_tmp98_ = g_initable_new (TYPE_MANAGER_PROXY, NULL, &_inner_error_, "g-flags", 0, "g-name", "org.freedesktop.systemd1", "g-bus-type", _tmp97_, "g-object-path", "/org/freedesktop/systemd1", "g-interface-name", "org.freedesktop.systemd1.Manager", NULL);
	_tmp99_ = (Manager*) _tmp98_;
...
void main_window_populate_unit_model (MainWindow* self, GError** error) {
	...
	}
	{
		...
		for (i_it = 0; i_it < list_length1; i_it = i_it + 1) {
			...
			ManagerUnitInfo i;
			manager_unit_info_copy (&i_collection[i_it], &_tmp3_);
			_tmp2_ = _tmp3_;
			i = _tmp2_;
			{
				GtkTreeIter iter = {0};
...
void main_window_populate_job_model (MainWindow* self, GError** error) {
	...
	}
	{
		...
		for (i_it = 0; i_it < list_length1; i_it = i_it + 1) {
			...
			ManagerJobInfo i;
			manager_job_info_copy (&i_collection[i_it], &_tmp3_);
			_tmp2_ = _tmp3_;
			i = _tmp2_;
			{
				GtkTreeIter iter = {0};
		...
		for (i_it = 0; i_it < dependencies_length1; i_it = i_it + 1) {
			...
			i = _tmp2_;
			{
				...
				if (g_strcmp0 (r, "") != 0) {
					...
					_tmp4_ = g_strconcat (r, _tmp3_, NULL);
					_g_free0 (r);
					r = _tmp4_;
				}
				if (first) {
					gchar* _tmp5_;
					_tmp5_ = g_strconcat (r, word, NULL);
					_g_free0 (r);
					r = _tmp5_;
					first = FALSE;
				}
				_tmp6_ = g_strconcat (" <a href=\"", i, NULL);
				_tmp7_ = _tmp6_;
				_tmp8_ = g_strconcat (_tmp7_, "\">", NULL);
				_tmp9_ = _tmp8_;
				_tmp10_ = g_strconcat (_tmp9_, i, NULL);
				_tmp11_ = _tmp10_;
				_tmp12_ = g_strconcat (_tmp11_, "</a>", NULL);
				_tmp13_ = _tmp12_;
				_tmp14_ = g_strconcat (r, _tmp13_, NULL);
				_g_free0 (r);
				r = _tmp14_;
				_g_free0 (_tmp13_);
				_g_free0 (_tmp11_);
...
void main_window_show_unit (MainWindow* self, Unit* unit) {
	...
	_tmp1_ = g_strdup ("");
	a = _tmp1_;
	_tmp2_ = unit_get_names (unit, &_tmp3_);
	{
		gchar** i_collection;
		int i_collection_length1;
		int i_it;
		i_collection = _tmp2_;
		i_collection_length1 = _tmp3_;
		for (i_it = 0; i_it < _tmp3_; i_it = i_it + 1) {
			gchar* _tmp4_;
			gchar* i;
			...
			i = _tmp4_;
			{
				...
				if (g_strcmp0 (a, "") == 0) {
					...
					_tmp6_ = g_strconcat ("\n", i, NULL);
					_tmp7_ = _tmp6_;
					_tmp8_ = g_strconcat (a, _tmp7_, NULL);
					_g_free0 (a);
					a = _tmp8_;
					_g_free0 (_tmp7_);
				}
	...
	_tmp9_ = unit_get_requires (unit, &_tmp10_);
	requires = _tmp9_;
	requires_length1 = _tmp10_;
	_requires_size_ = _tmp10_;
	_tmp11_ = unit_get_requires_overridable (unit, &_tmp12_);
	requires_overridable = _tmp11_;
	requires_overridable_length1 = _tmp12_;
	_requires_overridable_size_ = _tmp12_;
	_tmp13_ = unit_get_requisite (unit, &_tmp14_);
	requisite = _tmp13_;
	requisite_length1 = _tmp14_;
	_requisite_size_ = _tmp14_;
	_tmp15_ = unit_get_requisite_overridable (unit, &_tmp16_);
	requisite_overridable = _tmp15_;
	requisite_overridable_length1 = _tmp16_;
	_requisite_overridable_size_ = _tmp16_;
	_tmp17_ = unit_get_wants (unit, &_tmp18_);
	wants = _tmp17_;
	wants_length1 = _tmp18_;
	_wants_size_ = _tmp18_;
	_tmp19_ = unit_get_required_by (unit, &_tmp20_);
	required_by = _tmp19_;
	required_by_length1 = _tmp20_;
	_required_by_size_ = _tmp20_;
	_tmp21_ = unit_get_required_by_overridable (unit, &_tmp22_);
	required_by_overridable = _tmp21_;
	required_by_overridable_length1 = _tmp22_;
	_required_by_overridable_size_ = _tmp22_;
	_tmp23_ = unit_get_wanted_by (unit, &_tmp24_);
	wanted_by = _tmp23_;
	wanted_by_length1 = _tmp24_;
	_wanted_by_size_ = _tmp24_;
	_tmp25_ = unit_get_conflicts (unit, &_tmp26_);
	conflicts = _tmp25_;
	conflicts_length1 = _tmp26_;
	_conflicts_size_ = _tmp26_;
	_tmp27_ = unit_get_before (unit, &_tmp28_);
	before = _tmp27_;
	before_length1 = _tmp28_;
	_before_size_ = _tmp28_;
	_tmp29_ = unit_get_after (unit, &_tmp30_);
	after = _tmp29_;
	after_length1 = _tmp30_;
	_after_size_ = _tmp30_;
	_tmp31_ = main_window_make_dependency_string (self, NULL, "requires", requires, requires_length1);
	_tmp32_ = _tmp31_;
	_tmp33_ = main_window_make_dependency_string (self, _tmp32_, "overridable requires", requires_overridable, requires_overridable_length1);
	_tmp34_ = _tmp33_;
	_tmp35_ = main_window_make_dependency_string (self, _tmp34_, "requisite", requisite, requisite_length1);
	_tmp36_ = _tmp35_;
	_tmp37_ = main_window_make_dependency_string (self, _tmp36_, "overridable requisite", requisite_overridable, requisite_overridable_length1);
	_tmp38_ = _tmp37_;
	_tmp39_ = main_window_make_dependency_string (self, _tmp38_, "wants", wants, wants_length1);
	_tmp40_ = _tmp39_;
	_tmp41_ = main_window_make_dependency_string (self, _tmp40_, "conflicts", conflicts, conflicts_length1);
	_tmp42_ = _tmp41_;
	_tmp43_ = main_window_make_dependency_string (self, _tmp42_, "required by", required_by, required_by_length1);
	_tmp44_ = _tmp43_;
	_tmp45_ = main_window_make_dependency_string (self, _tmp44_, "overridable required by", required_by_overridable, required_by_overridable_length1);
	_tmp46_ = _tmp45_;
	_tmp47_ = main_window_make_dependency_string (self, _tmp46_, "wanted by", wanted_by, wanted_by_length1);
	_tmp48_ = _tmp47_;
	_tmp49_ = main_window_make_dependency_string (self, _tmp48_, "after", after, after_length1);
	_tmp50_ = _tmp49_;
	_tmp51_ = main_window_make_dependency_string (self, _tmp50_, "before", before, before_length1);
	_tmp52_ = _tmp51_;
	right_label_set_markup_or_na (self->priv->unit_dependency_label, _tmp52_);
	_g_free0 (_tmp52_);
	_g_free0 (_tmp50_);
	_g_free0 (_tmp48_);
	_g_free0 (_tmp46_);
	...
	_g_free0 (_tmp34_);
	_g_free0 (_tmp32_);
	_tmp53_ = unit_get_description (unit);
	_tmp54_ = _tmp53_;
	right_label_set_text_or_na (self->priv->unit_description_label, _tmp54_);
	_g_free0 (_tmp54_);
	_tmp55_ = unit_get_load_state (unit);
	_tmp56_ = _tmp55_;
	right_label_set_text_or_na (self->priv->unit_load_state_label, _tmp56_);
	_g_free0 (_tmp56_);
	_tmp57_ = unit_get_active_state (unit);
	_tmp58_ = _tmp57_;
	right_label_set_text_or_na (self->priv->unit_active_state_label, _tmp58_);
	_g_free0 (_tmp58_);
	_tmp59_ = unit_get_sub_state (unit);
	_tmp60_ = _tmp59_;
	right_label_set_text_or_na (self->priv->unit_sub_state_label, _tmp60_);
	_g_free0 (_tmp60_);
	_tmp61_ = unit_get_fragment_path (unit);
	fp = _tmp61_;
	if (g_strcmp0 (fp, "") != 0) {
		gchar* _tmp62_;
		gchar* _tmp63_;
		...
		gchar* _tmp68_;
		gchar* _tmp69_;
		_tmp62_ = g_strconcat ("<a href=\"file://", fp, NULL);
		_tmp63_ = _tmp62_;
		_tmp64_ = g_strconcat (_tmp63_, "\">", NULL);
		_tmp65_ = _tmp64_;
		_tmp66_ = g_strconcat (_tmp65_, fp, NULL);
		_tmp67_ = _tmp66_;
		_tmp68_ = g_strconcat (_tmp67_, "</a>", NULL);
		_tmp69_ = _tmp68_;
		right_label_set_markup_or_na (self->priv->unit_fragment_path_label, _tmp69_);
		_g_free0 (_tmp69_);
		_g_free0 (_tmp67_);
		_g_free0 (_tmp65_);
		_g_free0 (_tmp63_);
	...
	_tmp70_ = unit_get_active_enter_timestamp (unit);
	t = _tmp70_;
	if (t > 0) {
		struct tm _tmp71_ = {0};
		struct tm _tmp72_ = {0};
		...
		gchar* _tmp73_ = NULL;
		gchar* _tmp74_;
		g_time_local ((time_t) (t / 1000000), &_tmp71_);
		_tmp72_ = _tmp71_;
		timestamp = _tmp72_;
		_tmp73_ = g_time_format (&timestamp, "%a, %d %b %Y %H:%M:%S %z");
		_tmp74_ = _tmp73_;
		right_label_set_text_or_na (self->priv->unit_active_enter_timestamp_label, _tmp74_);
		_g_free0 (_tmp74_);
	} else {
		right_label_set_text_or_na (self->priv->unit_active_enter_timestamp_label, NULL);
	}
	_tmp75_ = unit_get_active_exit_timestamp (unit);
	t = _tmp75_;
	if (t > 0) {
		struct tm _tmp76_ = {0};
		struct tm _tmp77_ = {0};
		...
		gchar* _tmp78_ = NULL;
		gchar* _tmp79_;
		g_time_local ((time_t) (t / 1000000), &_tmp76_);
		_tmp77_ = _tmp76_;
		timestamp = _tmp77_;
		_tmp78_ = g_time_format (&timestamp, "%a, %d %b %Y %H:%M:%S %z");
		_tmp79_ = _tmp78_;
		right_label_set_text_or_na (self->priv->unit_active_exit_timestamp_label, _tmp79_);
		_g_free0 (_tmp79_);
	} else {
		right_label_set_text_or_na (self->priv->unit_active_exit_timestamp_label, NULL);
	}
	_tmp80_ = unit_get_can_start (unit);
	b = _tmp80_;
	...
	right_label_set_text_or_na (self->priv->unit_can_start_label, _tmp81_);
	_tmp82_ = unit_get_can_reload (unit);
	b = _tmp82_;
	...
	right_label_set_text_or_na (self->priv->unit_can_reload_label, _tmp83_);
	_tmp84_ = unit_get_default_control_group (unit);
	_tmp85_ = _tmp84_;
	right_label_set_text_or_na (self->priv->unit_cgroup_label, _tmp85_);
	_g_free0 (_tmp85_);
	_g_free0 (fp);
...
void main_window_update_unit_iter (MainWindow* self, GtkTreeIter* iter, const gchar* id, Unit* u) {
	...
	_tmp8_ = unit_get_description (u);
	_tmp9_ = _tmp8_;
	_tmp10_ = unit_get_load_state (u);
	_tmp11_ = _tmp10_;
	_tmp12_ = unit_get_active_state (u);
	_tmp13_ = _tmp12_;
	_tmp14_ = unit_get_sub_state (u);
	_tmp15_ = _tmp14_;
	gtk_list_store_set (self->priv->unit_model, iter, 0, id, 1, _tmp9_, 2, _tmp11_, 3, _tmp13_, 4, _tmp15_, 5, _tmp5_, 6, u, -1);
	_g_free0 (_tmp15_);
	_g_free0 (_tmp13_);
	_g_free0 (_tmp11_);
	_g_free0 (_tmp9_);
...
void main_window_on_unit_changed (MainWindow* self, Properties* p, const gchar* iface, GHashTable* changed_properties, gchar** invalidated_properties, int invalidated_properties_length1) {
	...
	_tmp3_ = g_initable_new (TYPE_UNIT_PROXY, NULL, &_inner_error_, "g-flags", 0, "g-name", _tmp1_, "g-bus-type", _tmp0_, "g-object-path", _tmp2_, "g-interface-name", "org.freedesktop.systemd1.Unit", NULL);
	u = (Unit*) _tmp3_;
	if (_inner_error_ != NULL) {
		_g_free0 (id);
		if (_inner_error_->domain == G_IO_ERROR) {
	...
	_tmp5_ = gtk_tree_model_get_iter_first ((GtkTreeModel*) self->priv->unit_model, &_tmp4_);
	iter = _tmp4_;
	if (!_tmp5_) {
		_g_object_unref0 (u);
		_g_free0 (id);
	...
	id = _tmp6_;
	{
		...
		while (TRUE) {
			...
			if (!_tmp7_) {
				gboolean _tmp8_;
				_tmp8_ = gtk_tree_model_iter_next ((GtkTreeModel*) self->priv->unit_model, &iter);
				if (!_tmp8_) {
					break;
				}
			}
...
void main_window_on_job_changed (MainWindow* self, Properties* p, const gchar* iface, GHashTable* changed_properties, gchar** invalidated_properties, int invalidated_properties_length1) {
	...
	_tmp1_ = g_dbus_proxy_get_name ((GDBusProxy*) p);
	_tmp2_ = g_dbus_proxy_get_object_path ((GDBusProxy*) p);
	_tmp3_ = g_initable_new (TYPE_JOB_PROXY, NULL, &_inner_error_, "g-flags", 0, "g-name", _tmp1_, "g-bus-type", _tmp0_, "g-object-path", _tmp2_, "g-interface-name", "org.freedesktop.systemd1.Job", NULL);
	j = (Job*) _tmp3_;
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == G_IO_ERROR) {
	...
	_tmp5_ = gtk_tree_model_get_iter_first ((GtkTreeModel*) self->priv->job_model, &_tmp4_);
	iter = _tmp4_;
	if (!_tmp5_) {
		_g_object_unref0 (j);
		return;
	...
	id = _tmp6_;
	{
		...
		while (TRUE) {
			...
			if (!_tmp7_) {
				gboolean _tmp8_;
				_tmp8_ = gtk_tree_model_iter_next ((GtkTreeModel*) self->priv->job_model, &iter);
				if (!_tmp8_) {
					break;
				}
			}
