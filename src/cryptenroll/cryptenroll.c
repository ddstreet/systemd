...
static int help(void) {
        ...
        printf("%s [OPTIONS...] BLOCK-DEVICE\n"
               ...
               "                       Enroll to an external TPM2 device\n"
...
static int run(int argc, char *argv[]) {
        ...
        case ENROLL_TPM2:
                slot = enroll_tpm2(cd, vk, vks, arg_tpm2_device, arg_tpm2_external_key, arg_tpm2_pcr_mask, arg_tpm2_public_key, arg_tpm2_public_key_pcr_mask, arg_tpm2_signature, arg_tpm2_pin);
                break;
