...
static char *arg_tpm2_external_public_key = NULL;
...
STATIC_DESTRUCTOR_REGISTER(arg_tpm2_external_public_key, freep);
...
static int help(void) {
        ...
        printf("%s [OPTIONS...] BLOCK-DEVICE\n"
               ...
               "     --tpm2-external-public-key=PATH\n"
               "                       Export to external public key\n"
...
static int parse_argv(int argc, char *argv[]) {
        ...
        static const struct option options[] = {
                ...
                { "tpm2-external-public-key",     required_argument, NULL, ARG_TPM2_EXTERNAL_PUBLIC_KEY },
        ...
        while ((c = getopt_long(argc, argv, "h", options, NULL)) >= 0) {
                ...
                case ARG_TPM2_EXTERNAL_PUBLIC_KEY:
                        r = parse_path_argument(optarg, /* suppress_root= */ false, &arg_tpm2_external_public_key);
                        if (r < 0)
                                return r;
...
static int run(int argc, char *argv[]) {
        ...
        case ENROLL_TPM2:
                slot = enroll_tpm2(cd, vk, vks, arg_tpm2_device, arg_tpm2_external_public_key, arg_tpm2_pcr_mask, arg_tpm2_public_key, arg_tpm2_public_key_pcr_mask, arg_tpm2_signature, arg_tpm2_pin);
                break;
